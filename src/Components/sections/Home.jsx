    ...
    >
      ...
      <div className="text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
          I'm full-stack developer who loves creafting clean,
          <br />
          scalable web applications. My goals is to build solutions that after
          both exceptional performance and a delightful user experience.
        </p>
        <div className="flex justify-center space-x-4">
          <a
            href="#projects"
            className="bg-blue-500 text-white py-3 px-6 rounded justidy-medium transition relative overflow-hidden hover:-translate-y-2
          ...
          <a
            href="#contact"
            className="border border-blue-500/50 text-blue-500 py-3 px-6 rounded font-medium transition-all duration-200 hover:-translate-y-2
